...
export type AuthorizeNetKeys = {
  __typename?: 'AuthorizeNetKeys';
...
export type CarrierWithRates = {
  ...
  shippingProviderId: Scalars['Int']['output'];
};
...
export type EmailBlacklistedError = ErrorResult & {
  __typename?: 'EmailBlacklistedError';
  errorCode: ErrorCode;
  message: Scalars['String']['output'];
};

export type EmailValidationResult = EmailBlacklistedError | InvalidDomainError | InvalidEmailError | ValidEmail;
...
export type InvalidDomainError = ErrorResult & {
  __typename?: 'InvalidDomainError';
  errorCode: ErrorCode;
  message: Scalars['String']['output'];
};
...
export type Model = {
  ...
  spacer?: Maybe<Scalars['String']['output']>;
};

export type ModelMapper = {
  __typename?: 'ModelMapper';
...
export type Mutation = {
  __typename?: 'Mutation';
  addGuestPaymentToOrder: AddPaymentToOrderResult;
  ...
  createAffiliate: ShopAffiliate;
  /** Create a new Customer Address */
  createCustomerAddress: Address;
  createGuestOrderCustomerUser?: Maybe<Customer>;
  ...
  setTaxCloudAuthorization: Order;
...
export type MutationAddGuestPaymentToOrderArgs = {
  input: PaymentInput;
};
...
export type MutationCreateGuestOrderCustomerUserArgs = {
...
export type MutationSetOrderShippingFieldsArgs = {
...
export type OrderCustomFields = {
  ...
  affiliateStatus?: Maybe<Scalars['Boolean']['output']>;
  ...
  shipStationID?: Maybe<Scalars['String']['output']>;
  targetRadio?: Maybe<Array<Scalars['String']['output']>>;
};
...
export type OrderFilterParameter = {
  ...
  shipStationID?: InputMaybe<StringOperators>;
...
export type OrderSortParameter = {
  ...
  shipStationID?: InputMaybe<SortOrder>;
...
export type OrderTrackingInfo = {
  ...
  orderPlaced: Scalars['DateTime']['output'];
  state: Scalars['String']['output'];
  trackingCodes: Array<Scalars['String']['output']>;
};
...
export type ProductVariantFilterParameter = {
  createdAt?: InputMaybe<DateOperators>;
  currencyCode?: InputMaybe<StringOperators>;
  discount_price?: InputMaybe<NumberOperators>;
...
export type ProductVariantSortParameter = {
  createdAt?: InputMaybe<SortOrder>;
  discount_price?: InputMaybe<SortOrder>;
...
export type Query = {
  ...
  authorizeNetKeys: AuthorizeNetKeys;
  /** An array of supported Countries */
  availableCountries: Array<Country>;
  carriersInfo?: Maybe<Array<Maybe<ShipStationCarrierTypeShop>>>;
  ...
  modelMappers?: Maybe<Array<Maybe<ModelMapper>>>;
   ...
   */
  order?: Maybe<Order>;
  orderAllAvailableRates: Array<CarrierWithRates>;
  /**
  ...
  orderShippingRates: Array<ShippingRates>;
  orderTrackingInfo?: Maybe<OrderTrackingInfo>;
  /** Get a Product either by id or slug. If neither 'id' nor 'slug' is specified, an error will result. */
  product?: Maybe<Product>;
  productVariant?: Maybe<ProductVariant>;
  productVariantByName?: Maybe<ProductVariant>;
  /** Get a list of Products */
  products: ProductList;
  /** Search Products based on the criteria set by the `SearchInput` */
  search: SearchResponse;
  shippingRates: Array<ShippingRates>;
  verifyTaxCloudAddress?: Maybe<TaxCloudAddressStatus>;
};
...
export type QueryOrderShippingRatesArgs = {
  carrierCode: Scalars['String']['input'];
  serviceCode?: InputMaybe<Scalars['String']['input']>;
};


export type QueryOrderTrackingInfoArgs = {
  orderCode: Scalars['String']['input'];
};
...
export type QueryProductVariantByNameArgs = {
  name: Scalars['String']['input'];
};
...
export type QueryVerifyTaxCloudAddressArgs = {
  input?: InputMaybe<VerifyAddressInput>;
};
...
export type ShipStationCarrierTypeAdmin = {
  __typename?: 'ShipStationCarrierTypeAdmin';
  ...
  primary?: Maybe<Scalars['Boolean']['output']>;
  requiresFundedAccount?: Maybe<Scalars['Boolean']['output']>;
  shippingProviderId?: Maybe<Scalars['Int']['output']>;
};

export type ShipStationCarrierTypeShop = {
  __typename?: 'ShipStationCarrierTypeShop';
  code?: Maybe<Scalars['String']['output']>;
  name?: Maybe<Scalars['String']['output']>;
  nickname?: Maybe<Scalars['String']['output']>;
  primary?: Maybe<Scalars['Boolean']['output']>;
...
export type ShippingRates = {
  ...
  shipmentCost: Scalars['Float']['output'];
};

export type ShippingRatesInput = {
  carrierCode: Scalars['String']['input'];
  confirmation?: InputMaybe<Scalars['String']['input']>;
  fromWarehouseId?: InputMaybe<Scalars['String']['input']>;
  heightInInches?: InputMaybe<Scalars['Float']['input']>;
  lengthInInches?: InputMaybe<Scalars['Float']['input']>;
  packageCode?: InputMaybe<Scalars['String']['input']>;
  residential?: InputMaybe<Scalars['Boolean']['input']>;
  serviceCode?: InputMaybe<Scalars['String']['input']>;
  toCity: Scalars['String']['input'];
  toCountry: Scalars['String']['input'];
  toPostalCode: Scalars['String']['input'];
  toState?: InputMaybe<Scalars['String']['input']>;
  weightInOunces: Scalars['Float']['input'];
  widthInInches?: InputMaybe<Scalars['Float']['input']>;
};

export type ShopAffiliate = Node & {
...
export type TaxCloudAddressStatus = {
  __typename?: 'TaxCloudAddressStatus';
  message?: Maybe<Scalars['String']['output']>;
...
export type UpdateOrderCustomFieldsInput = {
  ...
  affiliateCommission?: InputMaybe<Scalars['Float']['input']>;
  affiliateStatus?: InputMaybe<Scalars['Boolean']['input']>;
  ...
  shipStationID?: InputMaybe<Scalars['String']['input']>;
  targetRadio?: InputMaybe<Array<Scalars['String']['input']>>;
};
...
export type IsValidEmailQueryVariables = Exact<{
  email: Scalars['String']['input'];
}>;


export type IsValidEmailQuery = { __typename?: 'Query', isValidEmail: { __typename: 'EmailBlacklistedError', errorCode: ErrorCode, message: string } | { __typename: 'InvalidDomainError', errorCode: ErrorCode, message: string } | { __typename: 'InvalidEmailError', errorCode: ErrorCode, message: string } | { __typename: 'ValidEmail', valid: boolean } };
...
export type EligibleShippingMethodsQuery = { __typename?: 'Query', eligibleShippingMethods: Array<{ __typename?: 'ShippingMethodQuote', id: string, code: string, name: string, description: string, metadata?: any | null, price: any, priceWithTax: any }> };

export type AuthorizeNetKeysQueryVariables = Exact<{ [key: string]: never; }>;


export type AuthorizeNetKeysQuery = { __typename?: 'Query', authorizeNetKeys: { __typename?: 'AuthorizeNetKeys', clientKey: string, loginId: string } };
...
export type AddPaymentToOrderMutation = { __typename?: 'Mutation', addPaymentToOrder: { __typename?: 'IneligiblePaymentMethodError', errorCode: ErrorCode, message: string } | { __typename?: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | { __typename?: 'OrderPaymentStateError', errorCode: ErrorCode, message: string } | { __typename?: 'OrderStateTransitionError', errorCode: ErrorCode, message: string } | { __typename?: 'PaymentDeclinedError', errorCode: ErrorCode, message: string } | { __typename?: 'PaymentFailedError', errorCode: ErrorCode, message: string } };
...
export type OrderShippingRatesQueryVariables = Exact<{ [key: string]: never; }>;


export type OrderShippingRatesQuery = { __typename?: 'Query', orderAllAvailableRates: Array<{ __typename?: 'CarrierWithRates', name: string, code: string, nickname: string, shippingProviderId: number, primary?: boolean | null, services: Array<{ __typename?: 'ShippingRates', serviceName: string, serviceCode: string, shipmentCost: number, otherCost: number }> }> };
...
type ErrorResult_EmailBlacklistedError_Fragment = { __typename: 'EmailBlacklistedError', errorCode: ErrorCode, message: string };
...
type ErrorResult_InvalidDomainError_Fragment = { __typename: 'InvalidDomainError', errorCode: ErrorCode, message: string };

type ErrorResult_InvalidEmailError_Fragment = { __typename: 'InvalidEmailError', errorCode: ErrorCode, message: string };
...
export type ActiveCustomerOrdersQuery = { __typename?: 'Query', activeCustomer?: { __typename?: 'Customer', id: string, orders: { __typename?: 'OrderList', totalItems: number, items: Array<{ __typename?: 'Order', id: string, code: string, state: string, totalWithTax: any, orderPlacedAt?: any | null }> } } | null };
...
export type CurrentCustomerQuery = { __typename?: 'Query', activeCustomer?: { __typename: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, addresses?: Array<{ __typename?: 'Address', id: string, fullName?: string | null, company?: string | null, streetLine1: string, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, phoneNumber?: string | null, defaultShippingAddress?: boolean | null, defaultBillingAddress?: boolean | null, country: { __typename?: 'Country', id: string, code: string, name: string }, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null }> | null } | null };
...
export type UpdateCustomerMutation = { __typename?: 'Mutation', updateCustomer: { __typename: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null } };
...
export type OrderAddressFragment = { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null };

export type OrderDetailFragment = { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null };
...
export type SetOrderShippingAddressMutation = { __typename?: 'Mutation', setOrderShippingAddress: { __typename?: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } };
...
export type SetOrderBillingAddressMutation = { __typename?: 'Mutation', setOrderBillingAddress: { __typename?: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } };
...
export type SetCustomerForOrderMutation = { __typename?: 'Mutation', setCustomerForOrder: { __typename: 'AlreadyLoggedInError', errorCode: ErrorCode, message: string } | { __typename: 'EmailAddressConflictError', errorCode: ErrorCode, message: string } | { __typename: 'GuestCheckoutError', errorCode: ErrorCode, message: string } | { __typename: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } };
...
export type AddItemToOrderMutation = { __typename?: 'Mutation', addItemToOrder: { __typename: 'InsufficientStockError', errorCode: ErrorCode, message: string, order: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } } | { __typename: 'NegativeQuantityError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | { __typename: 'OrderLimitError', errorCode: ErrorCode, message: string } | { __typename: 'OrderModificationError', errorCode: ErrorCode, message: string } };
...
export type SetOrderShippingMethodMutation = { __typename?: 'Mutation', setOrderShippingMethod: { __typename?: 'IneligibleShippingMethodError', errorCode: ErrorCode, message: string } | { __typename?: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | { __typename?: 'OrderModificationError', errorCode: ErrorCode, message: string } };
...
export type AdjustOrderLineMutation = { __typename?: 'Mutation', adjustOrderLine: { __typename: 'InsufficientStockError', errorCode: ErrorCode, message: string, order: { __typename?: 'Order', id: string, code: string, state: string, subTotal: any, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }> } } | { __typename: 'NegativeQuantityError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | { __typename: 'OrderLimitError', errorCode: ErrorCode, message: string } | { __typename: 'OrderModificationError', errorCode: ErrorCode, message: string } };
...
export type RemoveOrderLineMutation = { __typename?: 'Mutation', removeOrderLine: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | { __typename: 'OrderModificationError', errorCode: ErrorCode, message: string } };

export type ActiveOrderFullQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveOrderFullQuery = { __typename?: 'Query', activeOrder?: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | null };
...
export type OrderByCodeQuery = { __typename?: 'Query', orderByCode?: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | null };

export type OrderTrackingInfoQueryVariables = Exact<{
  orderCode: Scalars['String']['input'];
}>;


export type OrderTrackingInfoQuery = { __typename?: 'Query', orderTrackingInfo?: { __typename: 'OrderTrackingInfo', state: string, orderPlaced: any, trackingCodes: Array<string> } | null };
...
export type ApplyCouponCodeMutation = { __typename?: 'Mutation', applyCouponCode: { __typename: 'CouponCodeExpiredError', errorCode: ErrorCode, message: string } | { __typename: 'CouponCodeInvalidError', errorCode: ErrorCode, message: string } | { __typename: 'CouponCodeLimitError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } };
...
export type RemoveCouponCodeMutation = { __typename?: 'Mutation', removeCouponCode?: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | null };

export type SetOrderCustomFieldMutationVariables = Exact<{
  input: UpdateOrderInput;
}>;


export type SetOrderCustomFieldMutation = { __typename?: 'Mutation', setOrderCustomFields: { __typename?: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } };
...
export type TransitionOrderToStateMutation = { __typename?: 'Mutation', transitionOrderToState?: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | { __typename?: 'OrderStateTransitionError', errorCode: ErrorCode, message: string, transitionError: string, fromState: string, toState: string } | null };

export type OrderLineFragment = { __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } };

export type ActiveOrderQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveOrderQuery = { __typename?: 'Query', activeOrder?: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } | null };

export type SetTaxCloudAuthorizationMutationVariables = Exact<{ [key: string]: never; }>;


export type SetTaxCloudAuthorizationMutation = { __typename?: 'Mutation', setTaxCloudAuthorization: { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, currencyCode: CurrencyCode, totalQuantity: number, subTotal: any, subTotalWithTax: any, shipping: any, shippingWithTax: any, total: any, totalWithTax: any, couponCodes: Array<string>, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any }>, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string, customFields?: { __typename?: 'CustomerCustomFields', callsign?: string | null } | null, user?: { __typename?: 'User', id: string } | null } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, billingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null, customFields?: { __typename?: 'AddressCustomFields', firstName?: string | null, lastName?: string | null, isResidential?: boolean | null } | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, code: string, name: string } }>, lines: Array<{ __typename?: 'OrderLine', id: string, quantity: number, unitPrice: any, linePrice: any, discounts: Array<{ __typename?: 'Discount', type: AdjustmentType, description: string, amount: any }>, productVariant: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, options: Array<{ __typename?: 'ProductOption', name: string, group: { __typename?: 'ProductOptionGroup', name: string } }>, product: { __typename?: 'Product', name: string, slug: string, featuredAsset?: { __typename?: 'Asset', source: string } | null } } }>, discounts: Array<{ __typename?: 'Discount', adjustmentSource: string, amount: any, amountWithTax: any, description: string, type: AdjustmentType }>, customFields?: { __typename?: 'OrderCustomFields', carrierCode?: string | null, serviceCode?: string | null, serviceName?: string | null } | null } };

export type CreateGuestOrderCustomerUserMutationVariables = Exact<{
  orderCode: Scalars['String']['input'];
}>;


export type CreateGuestOrderCustomerUserMutation = { __typename?: 'Mutation', createGuestOrderCustomerUser?: { __typename: 'Customer', id: string, emailAddress: string } | null };
...
export type ProductSummaryQuery = { __typename?: 'Query', products: { __typename?: 'ProductList', totalItems: number, items: Array<{ __typename?: 'Product', id: string, slug: string, updatedAt: any, variants: Array<{ __typename?: 'ProductVariant', id: string, sku: string, price: any, stockLevel: string, options: Array<{ __typename?: 'ProductOption', code: string, group: { __typename?: 'ProductOptionGroup', code: string } }>, customFields?: { __typename?: 'ProductVariantCustomFields', discount_price?: number | null } | null }> }> } };

export type ProductFragment = { __typename?: 'Product', id: string, slug: string, updatedAt: any, variants: Array<{ __typename?: 'ProductVariant', id: string, sku: string, price: any, stockLevel: string, options: Array<{ __typename?: 'ProductOption', code: string, group: { __typename?: 'ProductOptionGroup', code: string } }>, customFields?: { __typename?: 'ProductVariantCustomFields', discount_price?: number | null } | null }> };

export type ProductVariantFragment = { __typename?: 'ProductVariant', id: string, sku: string, price: any, stockLevel: string, options: Array<{ __typename?: 'ProductOption', code: string, group: { __typename?: 'ProductOptionGroup', code: string } }>, customFields?: { __typename?: 'ProductVariantCustomFields', discount_price?: number | null } | null };
...
export const RequestPasswordResetDocument = gql`
  ...
  requestPasswordReset(emailAddress: $emailAddress) {
    ...
    `;
export const IsValidEmailDocument = gql`
...
export const EligibleShippingMethodsDocument = gql`
  ...
  eligibleShippingMethods {
    ...
    `;
export const AuthorizeNetKeysDocument = gql`
...
export const EligiblePaymentMethodsDocument = gql`
  ...
  eligiblePaymentMethods {
    ...
    `;
export const OrderShippingRatesDocument = gql`
...
export const RemoveOrderLineDocument = gql`
  ...
  removeOrderLine(orderLineId: $orderLineId) {
    ...
    ${OrderDetailFragmentDoc}`;
export const ActiveOrderFullDocument = gql`
...
export const OrderByCodeDocument = gql`
  ...
  orderByCode(code: $code) {
    ...
    ${OrderDetailFragmentDoc}`;
export const OrderTrackingInfoDocument = gql`
...
export const RemoveCouponCodeDocument = gql`
  ...
  removeCouponCode(couponCode: $code) {
    ...
    ${OrderDetailFragmentDoc}`;
export const SetOrderCustomFieldDocument = gql`
...
export const ActiveOrderDocument = gql`
  ...
  activeOrder {
    ...
    ${OrderDetailFragmentDoc}`;
export const SetTaxCloudAuthorizationDocument = gql`
  ...
  setTaxCloudAuthorization {
    ...
    ${OrderDetailFragmentDoc}`;
export const CreateGuestOrderCustomerUserDocument = gql`
...
export const ProductSummaryDocument = gql`
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    ...
    IsValidEmail(variables: IsValidEmailQueryVariables, options?: C): Promise<IsValidEmailQuery> {
      return requester<IsValidEmailQuery, IsValidEmailQueryVariables>(IsValidEmailDocument, variables, options) as Promise<IsValidEmailQuery>;
    },
    ...
    authorizeNetKeys(variables?: AuthorizeNetKeysQueryVariables, options?: C): Promise<AuthorizeNetKeysQuery> {
      return requester<AuthorizeNetKeysQuery, AuthorizeNetKeysQueryVariables>(AuthorizeNetKeysDocument, variables, options) as Promise<AuthorizeNetKeysQuery>;
    },
    ...
    orderShippingRates(variables?: OrderShippingRatesQueryVariables, options?: C): Promise<OrderShippingRatesQuery> {
      return requester<OrderShippingRatesQuery, OrderShippingRatesQueryVariables>(OrderShippingRatesDocument, variables, options) as Promise<OrderShippingRatesQuery>;
    },
    ...
    CurrentCustomer(variables?: CurrentCustomerQueryVariables, options?: C): Promise<CurrentCustomerQuery> {
      return requester<CurrentCustomerQuery, CurrentCustomerQueryVariables>(CurrentCustomerDocument, variables, options) as Promise<CurrentCustomerQuery>;
    },
    ...
    activeOrderFull(variables?: ActiveOrderFullQueryVariables, options?: C): Promise<ActiveOrderFullQuery> {
      return requester<ActiveOrderFullQuery, ActiveOrderFullQueryVariables>(ActiveOrderFullDocument, variables, options) as Promise<ActiveOrderFullQuery>;
    },
    ...
    orderTrackingInfo(variables: OrderTrackingInfoQueryVariables, options?: C): Promise<OrderTrackingInfoQuery> {
      return requester<OrderTrackingInfoQuery, OrderTrackingInfoQueryVariables>(OrderTrackingInfoDocument, variables, options) as Promise<OrderTrackingInfoQuery>;
    },
    ...
    SetOrderCustomField(variables: SetOrderCustomFieldMutationVariables, options?: C): Promise<SetOrderCustomFieldMutation> {
      return requester<SetOrderCustomFieldMutation, SetOrderCustomFieldMutationVariables>(SetOrderCustomFieldDocument, variables, options) as Promise<SetOrderCustomFieldMutation>;
    },
    ...
    SetTaxCloudAuthorization(variables?: SetTaxCloudAuthorizationMutationVariables, options?: C): Promise<SetTaxCloudAuthorizationMutation> {
      return requester<SetTaxCloudAuthorizationMutation, SetTaxCloudAuthorizationMutationVariables>(SetTaxCloudAuthorizationDocument, variables, options) as Promise<SetTaxCloudAuthorizationMutation>;
    },
    createGuestOrderCustomerUser(variables: CreateGuestOrderCustomerUserMutationVariables, options?: C): Promise<CreateGuestOrderCustomerUserMutation> {
      return requester<CreateGuestOrderCustomerUserMutation, CreateGuestOrderCustomerUserMutationVariables>(CreateGuestOrderCustomerUserDocument, variables, options) as Promise<CreateGuestOrderCustomerUserMutation>;
    },
    ...
    ProductSummary(variables?: ProductSummaryQueryVariables, options?: C): Promise<ProductSummaryQuery> {
      return requester<ProductSummaryQuery, ProductSummaryQueryVariables>(ProductSummaryDocument, variables, options) as Promise<ProductSummaryQuery>;
    }
  };
}
